...
function Ushur(credentials) {
  ...
  this.hostname = credentials.hostname || null;
...
Ushur.prototype.auth = function () {
  ...
  return new Promise(function (resolve, reject) {
    var http = new Http('POST', undefined, 'rest/login', undefined, payload, _this.hostname);
...
Ushur.prototype.initEngagement = function (engagement) {
  ...
  if(engagement instanceof Engagement && engagement.userPhoneNo && engagement.campaignId){
    ...
    var http = new Http('POST', _this.tokenId, 'initUshur', {}, engagement, _this.hostname);
    return http.send();
  }else{
...
Ushur.prototype.getActivity = function (activityId) {
  ...
  var http = new Http('POST', _this.tokenId, 'infoQuery/getUshurActivity', {}, payload, _this.hostname);
  return http.send();
};
...
Ushur.prototype.getResponses = function (params = {}) {
  ...
  console.log("this params ===>", _this);
  var http = new Http('POST', _this.tokenId, 'infoQuery', {}, payload, _this.hostname);
  return http.send();
};
...
Ushur.prototype.addOrUpdateEnterpriseData = function (data) {
  ...
  var http = new Http('POST', this.tokenId, 'uneda/data/add', {}, payload, this.hostname);
  return http.send();
};
...
Ushur.prototype.getEnterpriseData = function (data) {
  ...
  var http = new Http('POST', this.tokenId, 'uneda/data/get', {}, payload, this.hostname);
  return http.send();
};
...
Ushur.prototype.deleteEnterpriseData = function (data) {
  ...
  var http = new Http('POST', this.tokenId, 'uneda/data/delete', {}, payload, this.hostname);
  return http.send();
};
...
Ushur.prototype.authentication = function (data) {
  ...
  var http = new Http('POST', this.tokenId, 'rest/account/phoneAuthService', {}, payload, this.hostname);
  return http.send();
};
...
Ushur.prototype.confirmation = function (data) {
  ...
  var http = new Http('POST', this.tokenId, 'rest/account/phoneAuthConfirm', {}, payload, this.hostname);
  return http.send();
};
...
Ushur.prototype.setCallbackNumber = function (data) {
  ...
  var http = new Http('PUT', this.tokenId, 'rest/campaign/'+ data.campaignId+'/callbackNo/'+ data.callbackNum, {}, payload, this.hostname);
  return http.send();
};
